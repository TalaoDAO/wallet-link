        ...
        if (b._modaldiv) b._trigger_callback("btnconnect_clicked", "hide"), b._modaldiv.parentElement.removeChild(b._modaldiv), b._modaldiv =
            ...
            for (var d = KV.get_available_providers(), c = "", e = 0; e < d.length; e++)switch (d[e]) {}d =
                function (l) {
                    ...
                    for (var g = document.getElementsByClassName("kvwalletbtn"), h = 0; h < g.length; h++)g[h].classList.remove("selected"), /*g[h].disabled = !0;*/ l.target.classList.add("selected");console.log(l.target); b._trigger_callback("wallet_connecting", l.target.id); switch (l.target.id) { case "kvwalletmodal_binance_btn": KV.set_provider("binancewallet"); break; case "kvwalletmodal_metamask_btn": KV.set_provider("metamask"); console.log("metamaskkkk");break; case "kvwalletmodal_coinbase_btn": console.log("coinbaseWallet");KV.set_provider("coinbasewallet"); break; case "kvwalletmodal_walletconnect_btn": console.log("walletconnectttt");KV.set_provider("walletconnect");  break; case "kvwalletmodal_walletconnect_btn2": KV.set_provider("walletconnect"); break;case "kvwalletmodal_walletconnect_btn4": KV.set_provider("walletconnect"); break;case "kvwalletmodal_walletconnect_btn5": KV.set_provider("walletconnect"); break; case "kvwalletmodal_walletconnect_btn3": KV.set_provider("walletconnect")}
